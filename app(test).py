...
CATEGORIES = {
    "Auto, Motos y Otros": "MLA373437",
    "Tapas de Radiadores": "MLA373334",
    "Librería": "MLA5982",
    "Beauty & Personal Care": "MLA1246",
    "Toys & Games": "MLA1132",
    "Books, Movies & Music": "MLA3025",
    "Vehicles": "MLA1743",
    "Fashion": "MLA1383043368",
    "Electronics": "MLA352001",
    "Computers": "MLA1648",
    "Cellphones & Smartphones": "MLA1051",
    "Cameras & Photography": "MLA1039",
    "Video Games & Consoles": "MLA1144",
    "Home & Garden": "MLA1574",
    "Tools & Construction": "MLA1500",
    "Industrial Equipment": "MLA1499",
    "Services": "MLA1540",
    "Real Estate": "MLA1459",
    "Food & Drinks": "MLA1403",
    "Office Supplies": "MLA1499",
    "Health & Medical Equipment": "MLA1246"
}
...
def main():
    ...
    use_manual_credentials = st.sidebar.checkbox("Credenciales API")
    ...
    if st.session_state.data:
        st.subheader(f"Top {len(st.session_state.data)} en {st.session_state.category}")
